...
EVAPORATION_ZIPS_FOLDER = os.path.join(DIR_PATH, "resources/evaporation/evaporation_grids_zips")
EVAPORATION_FOLDER = os.path.join(DIR_PATH, "resources/evaporation/evaporation_grids")
EVAPORATION_ZIP = os.path.join(DIR_PATH, "resources/evaporation/evap.zip")
...
def print_evaporation_urls():
    ...
    so we need to manually download them into EVAPORATION_ZIPS_FOLDER.
